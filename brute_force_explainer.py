...
def run_proper():
    ...
    tab_cols = ['Rating', 'Votes'] #['Year','Runtime (Minutes)', 'Rating', 'Votes', 'Revenue (Millions)','Metascore', 'Rank']
    ...
    print("       f(x) =", test_model.predict_both(np.array([x], dtype='O'), load_from_cache=False))
